...
const nav = [
  ...
  { to: "/tutor/batches", label: "My batches" },
  { to: "/tutor/classes", label: "Live classes" },
  { to: "/tutor/assignments", label: "Assignments" },
  { to: "/tutor/meetings", label: "Requests" },
  { to: "/tutor/chat", label: "Messages" },
];
    ...
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 flex">
      <aside className="w-64 shrink-0 border-r border-brand-100 dark:border-slate-800 bg-white dark:bg-slate-900 flex flex-col">
        <div className="px-4 pt-5 pb-4 border-b border-brand-100 dark:border-slate-800">
          ...
          <p className="mt-2 text-xs text-slate-500">Tutor portal</p>
        </div>
